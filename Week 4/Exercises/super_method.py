...
class Manager(Programmer):
    ...
    def __init__(self):
        super().__init__() # This will also call init of its parent class so no need to write __init__ of class Programmer, Also This method must be inside written inside def init of child class 
